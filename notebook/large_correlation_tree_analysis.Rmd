...
infraspecies %>%
  ...
  theme_minimal() +
  annotate("point", x=8,y=0.0206, col="black", size=5) +
  annotate("point", x=8,y=0.0206, col="yellow", size=4) -> p_R2_lineage
  #annotate("label", x=6,y=0.0140, label="Eubacterium\ngenus", size=3) +
  #annotate("label", x=7,y=0.0162, label="E. rectale\nspecies", size=3) +
  #annotate("label", x=8,y=0.0206, label="E. rectale\nsubspecies 1", size=3)-> p_R2_lineage
