...
nutriscore_DI %>%
     merge(.,
           ...
           by="Patient_ID") %>% with(.,cor.test(nutriscore_DI,as.numeric(SSgroup), method="spearman"))
...
diet_plot = cowplot::plot_grid(
  ...
  cowplot::plot_grid(
    ...
    cowplot::plot_grid(
      Gender_pcoa_plot+ cowplot::theme_cowplot(),
      Severity_pcoa_plot+ cowplot::theme_cowplot() + xlab("Symptoms severity"), nrow=2, labels=c("E","F")),
  ...
  cowplot::plot_grid(
    ...
    #nutriscore_severity_plot + cowplot::theme_cowplot() + theme(axis.text.x = element_text(angle = 45, hjust = 1)), 
    nutriscore_severity_plot + cowplot::theme_cowplot() ,
    rel_widths = c(1,1,1.3),nrow=1, labels=c("C","D","G")), nrow = 2, rel_heights = c(2,1))
...
ggsave("Diet_PCoA_food_tree_plot.pdf")
