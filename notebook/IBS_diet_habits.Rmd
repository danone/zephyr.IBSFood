...
diet_plot = cowplot::plot_grid(
  ...
  cowplot::plot_grid(
    ...
    cowplot::plot_grid(
      Gender_pcoa_plot+ cowplot::theme_cowplot(),
      Severity_pcoa_plot+ cowplot::theme_cowplot() + xlab("Symptoms severity"), nrow=2, labels=c("B","C")),
    rel_widths = c(4,1.2), labels=c("A","")),
  
  cowplot::plot_grid(
    meat_plant_pcoa_plot+ cowplot::theme_cowplot(),
    nutriscore_DI_plot+ cowplot::theme_cowplot(), 
    ...
    rel_widths = c(1,1,1.3),nrow=1, labels=c("D","E","F")), nrow = 2, rel_heights = c(2,1))
